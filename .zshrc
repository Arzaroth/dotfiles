...
# Should only be invoked via `zinit ice atpull"%atclone" atclone"_fix-omz-plugin"`
_fix-omz-plugin() {
...
zinit light-mode for \
  ...
  OMZL::correction.zsh \
    atinit'typeset -gx HIST_STAMPS=yyyy-mm-dd HISTSIZE=10000000 SAVEHIST=10000000 HISTFILE=${HOME}/.zsh_history' \
  OMZL::history.zsh
...
zinit has'docker' is-snippet wait lucid for \
    atpull"%atclone" atclone"_fix-omz-plugin" \
  OMZP::{docker,docker-compose}

zinit has'python' is-snippet wait lucid for \
  OMZP::{python,pip,virtualenv}

zinit as'completion' is-snippet wait lucid for \
  OMZP::httpie/_httpie
...
zinit \
  ...
  for @junegunn/fzf
zinit as'program' from'gh-r' id-as'JanDeDobbeleer/oh-my-posh' lucid nocompile mv'posh-* -> oh-my-posh' for @JanDeDobbeleer/oh-my-posh
zinit as'program' from'gh-r' id-as'ajeetdsouza/zoxide' lucid nocompile for @ajeetdsouza/zoxide
zinit as'program' from'gh-r' id-as'zellij-org/zellij' lucid nocompile for @zellij-org/zellij
